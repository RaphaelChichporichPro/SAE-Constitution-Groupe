...
public class Groupe {
	 ...
	 * @param e
	 */
	private List<Etudiant> membres = new ArrayList<>(); // Utilisation de List [cite: 18]

    public void ajouterEtudiant(Etudiant e) { 
        if (this.getTaille() < this.capacite) this.membres.add(e); 
    }
    public void retirerEtudiant(Etudiant e) { this.membres.remove(e); }
