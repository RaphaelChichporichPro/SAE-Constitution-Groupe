<?php
// Vue modification des notes (Responsable Pédagogique)
?>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<!-- Modal Modification Notes Étudiant -->
<div class="add-student-modal is-visible">
  <div class="add-student-dialog">
    <div class="add-student-body">
      <h2>Modifier les notes d'un étudiant</h2>
      <form class="add-student-form" action="vue/Responsable_Pédagogique/ConsultationNotes.php" method="post">
        <label class="add-field">
          <span>Nom</span>
          <input type="text" name="nom" placeholder="Saisissez le nom" value="">
        </label>
        <label class="add-field">
          <span>Prénom</span>
          <input type="text" name="prenom" placeholder="Saisissez le prénom" value="">
        </label>
        <label class="add-field">
          <span>Groupe</span>
          <input type="text" name="groupe" placeholder="Saisissez le groupe" value="">
        </label>
        <label class="add-field">
          <span>Matière</span>
          <input type="text" name="matiere" placeholder="Saisissez la matière" value="">
        </label>
        <label class="add-field">
          <span>Note</span>
          <input type="text" name="note" placeholder="Saisissez la note" value="">
        </label>
        <div class="add-student-actions">
          <a href="vue/Responsable_Pédagogique/ConsultationNotes.php" class="btn-primary" style="flex: 1; background: #ff6a00; text-decoration: none; display: inline-flex; align-items: center; justify-content: center;">Ajouter</a>
        </div>
      </form>
    </div>
  </div>
