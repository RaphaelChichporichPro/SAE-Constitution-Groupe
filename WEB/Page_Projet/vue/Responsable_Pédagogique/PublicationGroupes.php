<?php
// Vue publication des groupes (Responsable Pédagogique)
?>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<!-- Modal Publication Groupes -->
<div class="add-student-modal is-visible">
  <div class="publish-dialog">
    <div class="publish-body">
      <h2>Publier les groupes</h2>
      <p class="publish-subtitle">Cochez les groupes que vous souhaitez publier :</p>

      <form class="publish-checkboxes">
        <label class="publish-checkbox"><input type="checkbox"> <span>3A</span></label>
        <label class="publish-checkbox"><input type="checkbox"> <span>3D</span></label>
        <label class="publish-checkbox"><input type="checkbox"> <span>3APP1</span></label>

        <label class="publish-checkbox"><input type="checkbox"> <span>3B</span></label>
        <label class="publish-checkbox"><input type="checkbox"> <span>3E</span></label>
        <label class="publish-checkbox"><input type="checkbox"> <span>3APP2</span></label>

        <label class="publish-checkbox"><input type="checkbox"> <span>3C</span></label>
        <label class="publish-checkbox"><input type="checkbox"> <span>3D</span></label>
      </form>

      <div class="publish-button-container">
        <a href="vue/Responsable_Pédagogique/TableauDeBord.php" class="publish-submit-btn">Publier</a>
      </div>
    </div>
  </div>
</div>
