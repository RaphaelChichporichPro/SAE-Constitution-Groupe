<?php
// Vue import des notes (Responsable Pédagogique)
?>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<div class="add-student-modal is-visible">
  <div class="add-student-dialog">
    <div class="add-student-body">
      <h2>Importez les notes</h2>
      <form class="import-notes-form" action="vue/Responsable_Pédagogique/TableauDeBord.php" method="post" enctype="multipart/form-data">
        <div class="file-upload-area">
          <label for="file-input" class="file-upload-label">
            <div class="upload-icon">⬇</div>
            <p>Déposer vos fichiers</p>
            <input type="file" id="file-input" name="file" style="display: none;" accept=".csv">
          </label>
          <button type="button" class="btn-browse" onclick="document.getElementById('file-input').click();">Parcourir</button>
        </div>
        <div class="import-actions">
          <a href="vue/Responsable_Pédagogique/TableauDeBord.php" class="btn-close">✕ Fermer</a>
