<?php
// Vue suppression d'un étudiant (Responsable Pédagogique)
?>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<!-- Modal Suppression Étudiant Fixe -->
  ...
  <div class="add-student-dialog">
    <div class="add-student-body">
      ...
      <div class="deletion-message">
        <p>L'étudiant à bien été supprimé</p>
      </div>
      <div class="add-student-actions">
        <a href="vue/Responsable_Pédagogique/TableauDeBord.php" class="btn-primary" style="flex: 1;">Retourner</a>
      </div>
    </div>
  </div>
</div>
