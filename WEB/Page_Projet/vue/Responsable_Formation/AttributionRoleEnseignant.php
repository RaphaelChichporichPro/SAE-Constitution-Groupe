<?php
// Vue Attribution de rôles Responsable Formation
?>
<!doctype html>
<html lang="fr">
	<head>
		...
		<title>Attribuer Droits/Rôles aux Enseignants - Responsable Formation</title>
	...
	<div class="modal-overlay is-visible">
		<div class="modal-dialog" role="dialog" aria-modal="true" aria-labelledby="modal-title">
			<form class="modal-form" action="vue/Responsable_Formation/TableauDeBord.php" method="get">
				<h2 id="modal-title">Attribuer Droits/<br/>Rôles aux<br/>Enseignants</h2>
				<div class="form-row">
					<label>Nom</label>
					<input name="nom" type="text" placeholder="Saisissez votre le nom">
				</div>
				<div class="form-row">
					<label>Prénom</label>
					<input name="prenom" type="text" placeholder="Saisissez le prénom">
				</div>
				<div class="form-row">
					<label>Rôles</label>
					<input name="roles" type="text" placeholder="Saisissez le rôle à attribuer">
				</div>
				<div class="form-actions">
					<a href="vue/Responsable_Formation/TableauDeBord.php" class="btn btn-secondary">Retour</a>
