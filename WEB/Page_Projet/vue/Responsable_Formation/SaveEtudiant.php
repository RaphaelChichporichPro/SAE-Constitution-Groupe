<?php
// Vue Enregistrement Enseignant Responsable Formation
?>
<!doctype html>
<html lang="fr">
	<head>
	...
	<div class="modal-overlay is-visible">
		<div class="modal-dialog" role="dialog" aria-modal="true" aria-labelledby="modal-title">
			<form class="modal-form" action="vue/Responsable_Formation/TableauDeBord.php" method="get">
				<h2 id="modal-title">Enregistrement<br/>Enseignant</h2>
				<div class="form-row">
					<label>Nom</label>
				...
				<div class="form-row">
					<label>Matière</label>
					<input name="matiere" type="text" placeholder="Saisissez la matière">
				</div>
				<div class="form-row">
					<label>Groupe</label>
					<input name="groupe" type="text" placeholder="Saisissez le groupe">
				</div>
